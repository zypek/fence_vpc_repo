...
def remove_security_groups(ec2_client, instance_id, sg_to_remove, interfaces):
    ...
    #print("HHAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")
    #for interface in interfaces:
        ...
        #)
        #logger.info(
            #f"Successfully updated interface {interface['NetworkInterfaceId']} with new SGs."
        #)
...
# Main function
def main():
    device_opt = ["region", "no_password", "access_key", "secret_key", "sg", "plug", "skip_race_check"]
    define_new_opts()
